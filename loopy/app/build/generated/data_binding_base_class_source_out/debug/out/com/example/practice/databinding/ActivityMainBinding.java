...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView,
      @NonNull FragmentContainerView frMain, @NonNull ConstraintLayout main,
      @NonNull BottomNavigationView mainBnv, @NonNull ImageView mainMiniplayerBtn,
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.fr_main;
      FragmentContainerView frMain = ViewBindings.findChildViewById(rootView, id);
      if (frMain == null) {
        break missingId;
      }
      ...
      return new ActivityMainBinding((ConstraintLayout) rootView, frMain, main, mainBnv,
